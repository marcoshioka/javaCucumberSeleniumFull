...
formatter.step({
  "line": 21,
  "name": "insiro as informações de CNH",
  "keyword": "E "
});
formatter.step({
  "line": 22,
  "name": "insiro as informações de contato",
  "keyword": "E "
});
formatter.step({
  "line": 23,
  "name": "seleciono Tentar mais tarde para envio do SMS",
  "keyword": "E "
});
formatter.step({
  "line": 24,
  "name": "informo que não sou politicamente exposto",
  "keyword": "E "
});
formatter.step({
  "line": 25,
  "name": "informo minha profissão",
  "keyword": "E "
});
formatter.step({
  "line": 26,
  "name": "informo minha renda, sem patrimônio",
  "keyword": "E "
});
formatter.step({
  "line": 27,
  "name": "informo Não em todos os itens de Declarações e Autorizações",
  "keyword": "E "
});
formatter.match({
...
formatter.match({
  "location": "CadastroSteps.insiro_as_informações_de_CNH()"
});
formatter.result({
  "duration": 3371026733,
  "status": "passed"
...
formatter.match({
  "location": "CadastroSteps.insiro_as_informações_de_contato()"
});
formatter.result({
  "duration": 1224204212,
  "status": "passed"
...
formatter.match({
  "location": "CadastroSteps.seleciono_Tentar_mais_tarde_para_envio_do_SMS()"
});
formatter.result({
  "duration": 1748890936,
  "status": "passed"
...
formatter.match({
  "location": "CadastroSteps.informo_que_não_sou_politicamente_exposto()"
});
formatter.result({
  "duration": 1117754091,
  "status": "passed"
...
formatter.match({
  "location": "CadastroSteps.informo_minha_profissão()"
});
formatter.result({
  "duration": 1330587364,
  "status": "passed"
...
formatter.match({
  "location": "CadastroSteps.informo_minha_renda_sem_patrimônio()"
});
formatter.result({
  "duration": 3211124985,
  "status": "passed"
...
formatter.match({
  "location": "CadastroSteps.informo_Não_em_todos_os_itens_de_Declarações_e_Autorizações()"
});
formatter.result({
  "duration": 1046448350,
  "status": "passed"
